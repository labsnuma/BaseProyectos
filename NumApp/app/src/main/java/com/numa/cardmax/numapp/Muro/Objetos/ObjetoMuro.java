...
public class ObjetoMuro {
    ...
    public int compartido_publicacion;
    public int top;
    ...
    public ObjetoMuro(String key, String titulo_publicacion, String contenido_publicacion, String fecha_publicacion, String imagen_publicacion, int comentarios_publicacion, int like_publicacion, int dislike_publicacion, int on_like, int on_dislike, int on_comentarios, int on_compartir, String id_usuario, int compartido_publicacion, int top, String programas, String semestre, String ciudades, String genero, String intereses, String estado_civil, int edadini, int edadfin, int type_pub) {
        this.key = key;
        ...
        this.compartido_publicacion = compartido_publicacion;
        this.top = top;
    ...
    public int getCompartido_publicacion() {
        return compartido_publicacion;
    }

    public void setCompartido_publicacion(int compartido_publicacion) {
        this.compartido_publicacion = compartido_publicacion;
    }
