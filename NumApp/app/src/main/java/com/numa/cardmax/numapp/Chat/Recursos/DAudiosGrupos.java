...
public class DAudiosGrupos {
    ...
    public DAudiosGrupos(Context context) {
        mContexto = context;
    }

    public void DescargarAudio(String urlAudio, String idguardada, String NombreGrupo,String nombreAudio,
        ...
        File dir = new File(file_path + "/NumAPP/" + "Audio/" + "Grupos/" + NombreGrupo + "/" + tipo + idguardada);
        ...
        if (!dir.exists()) {
            ...
            if (audio.exists()) {
                ...
                new DescargarAudioFire().execute(urlAudio, idguardada, nombreAudio, NombreGrupo);
                reporducirAudio(myUri1, btnreproducir, seekBar, btnpause);
            ...
            if (audio.exists()) {
                ...
                new DescargarAudioFire().execute(urlAudio, idguardada, nombreAudio, tipo, NombreGrupo);
                reporducirAudio(myUri1, btnreproducir, seekBar, btnpause);
            }
        }
    }
    ...
    class DescargarAudioFire extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                String tipo = f_url[3];
                String NombreGrupo = f_url[4];
                //File dir = new File(file_path + "/NumAPP/" + "Audio/" + "Send/" + carpeta + nombre + ".3gp");
                File dir = new File(file_path + "/NumAPP/" + "Audio/" + "Grupos/" + NombreGrupo + "/"
                        + tipo + carpeta + nombre + ".3gp");
    ...
    public void Iniciar(Context context, String urlAudio, String idguardada, String NombreGrupo, String nombreAudio,
                        FloatingActionButton btnreproducir, SeekBar seekBar, FloatingActionButton btnpause, String tipo) {
        try {
            if (mediaPlayer.isPlaying()) {
            ...
            DescargarAudio(urlAudio, idguardada, NombreGrupo,
